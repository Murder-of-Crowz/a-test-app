    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <Text style={styles.tagline}>
          {spanish
            ? "Preparación para la Junta Estatal de Estética"
            : "Esthetician State Board Prep"}
        </Text>
        ...
        <Text style={styles.subtitle}>
          {spanish
            ? "Más de 1,100 preguntas de práctica\nsobre cuidado de la piel, faciales, depilación y más"
